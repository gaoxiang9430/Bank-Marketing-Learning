...
def import_data():
    ...
    dataX =  np.delete(np.genfromtxt("data_nn/pre_processed_training_data_11_10_5.csv", delimiter=","), 0, axis=0)
    dataY = np.delete(np.genfromtxt("data_nn/training_labels_11_10_5.csv", delimiter=","), 0, axis=0)
    trainX, validationX, trainY, validationY = train_test_split(dataX, dataY, test_size=0.1, random_state=100)

    print("loading testing data")
    testX = np.delete(np.genfromtxt("data_nn/pre_processed_testing_data_11_10_5.csv", delimiter=","), 0, axis=0)
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
    ...
    for epoch in range(training_epochs):
        ...
        returned_predicted_results_model_1,returned_predicted_results_model_2,returned_predicted_results_ensemble = sess.run([predicted_results_model_1,predicted_results_model_2,predicted_results_ensemble_model], feed_dict={X: validationX, Y: validationY, dropout_keep_prob:dropout_keep_prob_input})
    ...
    draw_graphs(mean_loss_for_epoch_model_1,mcc_score_model_1,"model_1")
    draw_graphs(mean_loss_for_epoch_model_2, mcc_score_model_2, "model_2")
...
write_output_file("results_11_10_6.csv",predicted_results_ensemble_model)
